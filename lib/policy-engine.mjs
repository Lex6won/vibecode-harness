...
export const POLICY_PROFILES = Object.freeze({
  ...
  typescript_supabase: Object.freeze({
    id: "typescript_supabase",
    display_name: "TypeScript · Supabase 엄격형",
    allowed_languages: ["typescript"],
    allowed_implementation_extensions: [".ts", ".tsx"],
...
export const RUNTIME_PROFILE_TO_POLICY = Object.freeze({
  ...
  typescript_supabase: "typescript_supabase",
